            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const Text(
                    "Entrez vos identifiants ou continuez\navec...",
                    textAlign: TextAlign.center,
                    style: TextStyle(color: Color(0xFF757575)),
                  ),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.05), // Ligne corrigée
                  const SignUpForm(),
...
class _SignUpFormState extends State<SignUpForm> {
  ...
  Future<Map<String, dynamic>> _registerUser(String email, String password) async {
    const String apiUrl = 'http://localhost:5000/api/users'; // URL de l'API
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return {
          'success': true,
          'userId': data['insertId'].toString(), // Convertir en String pour HomeScreen
